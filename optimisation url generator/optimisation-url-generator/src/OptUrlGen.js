	...
	render() {
		...
		return (
			<div className = "OptUrlGen">
				...
				<pre>{JSON.stringify({ minMax, metric1, metric2, lg, metricFloat,}, null, 2)}</pre>
				<strong>onSubmit:</strong>
				<pre>{JSON.stringify({ submittedMinMax, submittedMetric1, submittedMetric2, submittedLg, submittedMetricFloat, }, null, 2)}</pre>
			</div>
	)
  }
}