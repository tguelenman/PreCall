...
\item \includegraphics[scale=0.5]{ORESscores}
...
\item \includegraphics[scale=0.7]{ORESscoresId}
\end{description}
...
\item \includegraphics[scale=0.8]{ORESscoresType}
\end{description}
\end{itemize}
...
\item \includegraphics[scale=0.6]{ORESarticlequalityThresholds}
\end{description}
\subsubsection{Different parameters}
Same as above.
...
\end{itemize}
\begin{description}
\item \includegraphics[scale=0.7]{ORESmaxFilterAtRecall}
\end{description}
\begin{itemize}
