...
\includegraphics[scale=.3]{confusionMatrix}
...
\end{description}
\includegraphics[scale=0.5]{ROCcurve}
\begin{description}
...
\item \includegraphics[scale=0.7]{limeExplainer}
\end{description}
\end{itemize}
...
\includegraphics[scale=0.4]{confusionCircle}
\begin{description}
...
\item $=\frac{\includegraphics[scale=0.1]{confusionCircleTP}}{\includegraphics[scale=0.1]{confusionCircleTP+FN}}$
\end{itemize}
...
\item $=\frac{\includegraphics[scale=0.1]{confusionCircleTP}}{\includegraphics[scale=0.1]{confusionCircleTP+FP}}$
\end{itemize}
...
\includegraphics[scale=0.7]{loanML3}\\
\begin{description}
...
\begin{description}
\item \includegraphics[scale=0.7]{PRcurve}
...
\subsection{accuracy}
\begin{itemize}
\item \textbf{accuracy}$= \frac{\texttt{TP}+\texttt{TN}}{\texttt{Total}} =\frac{\includegraphics[scale=0.1]{confusionCircleTP+TN}}{\includegraphics[scale=0.1]{confusionCircleTotal}}$
\end{itemize}
\subsection{match\_rate}
\begin{itemize}
\item ``The proportion of observations matched/not-matched''
\item \textbf{match\_rate} $=\frac{\texttt{TP}+\texttt{FP}}{\texttt{Total}}=\frac{\includegraphics[scale=0.1]{confusionCircleTP+FP}}{\includegraphics[scale=0.1]{confusionCircleTotal}}$
\end{itemize}
...
\item $=\frac{\texttt{TN}+\texttt{FN}}{\texttt{Total}} = \frac{\includegraphics[scale=0.1]{confusionCircleTN+FN}}{\includegraphics[scale=0.1]{confusionCircleTotal}}$
\end{itemize}
\subsection{!$<$metric$>$}
\begin{itemize}
...
\end{itemize}
%TODO -counts -rates\\
%TODO google discr. alles mit der grafik nochmal erklären?
...
\includegraphics[scale=0.6]{confusedPiePlots}
\begin{description}
