...
\end{description}
\begin{itemize}
\item \textbf{abstrackr}: ``online tool to support screening for systematic reviews of published medical evidence'' (classification of relevant citations)
...
\end{description}
\begin{itemize}
\item CueFlik (Fogarty et al.): ``interactive application that allows users to create their own concepts to incorporate into image search''
\begin{description}
