...
\begin{itemize}
\item false: \textcolor{pGreen}{... but actually being false}
\item true: \textcolor{pGreen}{... and actually being true}
\end{itemize}
\end{itemize}
\end{itemize}
...
\item \textbf{labels}:
\begin{itemize}
\item false (actual negatives): $\includegraphics[scale=0.3]{resources/5/exampleTN}+\includegraphics[scale=0.3]{resources/5/exampleFP}=55+10=65$ 
\item true (actual positives): $\includegraphics[scale=0.3]{resources/5/exampleTP}+\includegraphics[scale=0.3]{resources/5/exampleFN}= 30+5=35$
\end{itemize}
\item \textbf{n} (Total): $100$
\item \textbf{predictions}:
\begin{itemize}
\item false (predicted as false): $\includegraphics[scale=0.3]{resources/5/exampleTN}+\includegraphics[scale=0.3]{resources/5/exampleFN} = 55+5=60$
\begin{itemize}
\item false (predicted as false and actually false): $\includegraphics[scale=0.3]{resources/5/exampleTN} = 55$
\item true (predicted as false but actually true):  $\includegraphics[scale=0.3]{resources/5/exampleFN} = 5$
\end{itemize}
\item true (predicted as true): $\includegraphics[scale=0.3]{resources/5/exampleFP}+\includegraphics[scale=0.3]{resources/5/exampleTP} = 10+30=40$
\begin{itemize}
\item false (predicted as true but actually false): $\includegraphics[scale=0.3]{resources/5/exampleFP} = 10$
\item true (predicted as true and actually true): $\includegraphics[scale=0.3]{resources/5/exampleTP} = 30$
\end{itemize}
\end{itemize}
\end{itemize}
\item -
...
\item \textit{predictions}: \textit{false} and \textit{true} as parents of another two of those are the labels and the values of their ``child''-booleans are the actual values of edits
