...
\end{itemize}
\item The number of edits (\textit{manually}) labeled as \textit{false} and \textit{true}: these values represent the \textbf{actual} positives and negatives.
\item In the example, actual positives and negatives refer to:
\begin{itemize}
\item Actual negatives: $\includegraphics[scale=0.3]{resources/5/exampleTP}+\includegraphics[scale=0.3]{resources/5/exampleFN}= 30+5=35$
\item Actual positives: $\includegraphics[scale=0.3]{resources/5/exampleTN}+\includegraphics[scale=0.3]{resources/5/exampleFP}=10+55=65$
\end{itemize}
\item -
