...
Once more querying \href{https://ores.wikimedia.org/v3/scores/enwiki/?models=damaging&model_info=statistics}{ORES}, you'll notice that most metrics contain entries, labeled with ``macro'' and ``micro'':
\begin{description}
\item \includegraphics[scale=0.7]{resources/5/macroAndMicro}
\end{description}
%TODO http://rushdishams.blogspot.com/2011/08/micro-and-macro-average-of-precision.html
%
%
%
%
