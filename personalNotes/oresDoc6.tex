...
\paragraph{Note: }
\begin{itemize}
\item The metrics \colorbox{yellow}{pr\_auc}, \colorbox{yellow}{roc\_auc}, \colorbox{yellow}{counts} and \colorbox{yellow}{rates} are not part of the available parameters for this type of query. Neither is \colorbox{yellow}{threshold}. %TODO confirm threshold not being part of it =QUESTION2
...
Started Implementation. See on GitHub.
\end{document}