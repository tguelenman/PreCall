...
f1 & Harmonic mean of recall and precision & $2*\frac{\texttt{prec} * \texttt{rec}}{\texttt{prec}+\texttt{rec}}$\\\hline
...
\end{tabular}
%TODO negated values correct?
%TODO metrics document: change order?
